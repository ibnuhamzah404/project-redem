...
<html>
   ...
   <body>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-7 col-sm-12 col-spin">
                  <div class="card-wheel mt-5">
                     ...
                     <div class="position-relative">
                        ...
                        <div class="toast " style="top : 100px; left : 0; margin : 0 auto; right : 0; background : rgba(36, 33, 33, 0.85);">
                           <p></p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-5 col-sm-12 d-flex">
                  <div class="card-text">
                     <h2>Kesempatan emas menanti anda!</h2>
                     <p>
                        kamu berkesempatan mendapatkan vocher, diskon atau hadiah
                        spesial lainnya
                     </p>
                     <p>
                        cukup tekan tombol spin jika anda beruntung maka akan
                        mendapatkan hadiah spesial
                     </p>
                     <img
                        class="arrow"
                        style="width: 150px; margin: 0 auto; display: inherit"
                           ...
                           <li class="nav-item mb-2">
                              <a href="#" class="nav-link p-0 text-muted">
                                 <svg
                                    ...
                                    >
                                    <path
                                       d="M448 384V141.8l-131.1 99.8L385 319l-2 2-78.9-69.6L256 288l-48.1-36.6L129 321l-2-2 68-77.4L64 142v242z"
                                       ></path>
                                    <path d="M439.7 128H72l184 139.9z"></path>
                                 </svg
                                    >
                                 royalsguard.id@gmail.com
                              </a>
                           </li>
                        </ul>
                     </div>
      ...
      <script src="https://gacha.royalsguard.com/js/Draggable.min.js"></script>
      <script src="https://gacha.royalsguard.com/js/InertiaPlugin.min.js"></script>
      <script src="https://gacha.royalsguard.com/js/TextPlugin.min.js"></script>
      <script src="https://gacha.royalsguard.com/js/Spin2WinWheel.min.js"></script>
      <script src="https://gacha.royalsguard.com/js/index.js"></script>
